...
The model was trained strictly on the training partition. The test set was never accessed during training to prevent data leakage. After the full preprocessing pipeline, the training set contains 23,945 samples and 69 features, while the test set contains 5,987 samples and 69 features. The 69-feature space is the result of the full ColumnTransformer pipeline applied by Role 1, including one-hot encoding of all categorical variables (PAY\_0 through PAY\_6, EDUCATION, MARRIAGE, SEX).
...
\midrule
\textbf{Non-Default (0)} & 0.87 & 0.83 & 0.85 & 4661 \\
\textbf{Default (1)} & 0.48 & 0.56 & 0.52 & 1326 \\
\midrule
\textbf{accuracy} &  &  & 0.77 & 5987 \\
\textbf{macro avg} & 0.67 & 0.69 & 0.68 & 5987 \\
\textbf{weighted avg} & 0.78 & 0.77 & 0.77 & 5987 \\
\bottomrule
\end{tabular}
